	...
	<div class="container">
		...
		<form class="form-horizontal" action="update" method="post" name='frm'
			...
			<div class="form-group">
				...
				<div class="col-sm-4">
					<img src="/member/storage/${dto.fname}" class="img-rounded" width="200px" height="200px">
					<button type="button" class="btn btn-default" 
					onclick="location.href='./updateFile/${dto.id}/${dto.fname}'">사진 수정</button>
				</div>
				<input type="hidden" id="fname" name="fname" value="${dto.fname}">
			</div>
			<div class="form-group">
