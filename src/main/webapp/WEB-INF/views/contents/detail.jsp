	...
	<div class="container">
		<div class="row">
			<div class="col-sm-3">
				...
				<div class="caption"><p>상품명:${dto.pname}</p><p>${dto.detail }</p>
				</div>
			</div>
			<div class="col-sm-6">
				...
				<ul class="list-group">
					<li class="list-group-item">사이즈 : <c:choose>
							...
							<c:when test="${dto.cateno==2 }">
								<select id="size" class="form-select" aria-label="Default select example" disabled="disabled">
									<option selected>사이즈 선택</option>
								</select>
							</c:when>
					...
					<li class="list-group-item">수량 : <input type="number" id="count" name="quantity" min=0 max=20 value="1">
					<li class="list-group-item">
					<img class='btn' id='cartBtn' src="/svg/cart4.svg"/>
					<a href="javascript:order()"><img class='btn' src="/svg/bag-heart-fill.svg" /></a>
					...
					<div class="panel-body">
						<ul class="chat list-group">
							<!-- li class="left clearfix" data-rno="12">
								<div>
									<div class="col-md-6">
										<span>작성된 후기가 없습니다. 첫번째 후기를 작성해 주세요</span>
									</div>
								</div>
							</li> -->
						</ul>
