		...
		<form class="form-inline" action="./list">
			<div class="form-group">
				<select class="form-control" name="col">
					<option value="cateno" <c:if test= "${col=='cateno'}"> selected </c:if>>상품분류(Jean:1,Bag:2)</option>
					...
					<c:otherwise>
						<c:forEach var="dto" items="${list}">
							<tr>
								...
								<td><img src="/contents/storage/${dto.filename}" class="img-rounded" width="100px" height="100px"></td>
								...
								<td>${dto.rdate}</td>
								<td>${dto.stock}</td>
								<td><a href="./update/${dto.contentsno }"> <span class="glyphicon glyphicon-edit"></span>
								</a><a href="./delete/${dto.contentsno }"> <span class="glyphicon glyphicon-trash"></span>
